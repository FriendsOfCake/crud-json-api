...
class InclusionIntegrationTest extends JsonApiBaseTestCase
{
    ...
    public function testInclusion($url, $expectedFile)
    {
        ...
        $this->assertResponseEquals($this->_getJsonApiResponseBody('Inclusion' . DS . $expectedFile));
    }
    ...
    public function testViewWithContain()
    {
        ...
        $this->assertResponseSuccess();
        $this->assertResponseEquals($this->_getJsonApiResponseBody('Inclusion' . DS . 'get-country-include-currency-and-culture.json'));
